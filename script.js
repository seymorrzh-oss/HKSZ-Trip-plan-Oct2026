...

  {
    ...
    timeline: [
...

      {
        ...
        title: "The Henderson",
        detail:
          "Zaha Hadid Architects · 摄影重点",
        city: "hongkong",
        mapQuery:
          "The Henderson 2 Murray Road Hong Kong"
      },
...
const places = [
...

  {
    ...
    detail:
      "MAD Architects · 马岩松 · AirPods 建筑 · 免费公共区域优先",
...

  {
    ...
    detail:
      "你确认的目标构图机位：人才公园 + MAD 深圳湾文化广场 + 春笋",
    ...
    photoNote:
      "🌇 日落前到位 → 拍至蓝调亮灯。iPhone 17 优先主摄约 1.5–2× 构图；Pocket 4 适合固定延时、慢推和竖屏城市镜头。"
...

  {
    ...
    photoNote:
      "📱 到达现场后优先观察天桥高度、The Henderson 与中银大厦之间的叠景关系，再决定 1× / 2× 构图。"
    ...
    (place, index) => {
      ...
      card.innerHTML = `
        ...
        <div class="place-actions">
          ...
          <button
            class="check-button"
            data-place-index="${places.indexOf(place)}"
            type="button"
          >
